...
def build_ontology() -> Graph:
    ...
    add_class(g, LT.StopTime, "Stop Time", "Arrival and departure times at a stop for a trip", LT.TransportEntity)
    ...
    add_class(g, LT.BusRoute, "Bus Route", "A route used by buses", LT.Route)
    add_class(g, LT.TrainRoute, "Train Route", "A route used by trains", LT.Route)

    add_class(g, LT.BusStop, "Bus Stop", "A stop specifically for bus services", LT.Stop)
    add_class(g, LT.TrainStation, "Train Station", "A station for train services", LT.Stop)
    ...
    add_datatype_property(g, LT.latitude, "latitude", "Latitude of a stop", LT.Stop, XSD.float, LT.value)
    add_datatype_property(g, LT.longitude, "longitude", "Longitude of a stop", LT.Stop, XSD.float, LT.value)
    ...
    add_datatype_property(g, LT.arrivalTime, "arrival time", "Arrival time at a stop", LT.StopTime, XSD.string, LT.value)
    add_datatype_property(g, LT.departureTime, "departure time", "Departure time from a stop", LT.StopTime, XSD.string, LT.value)
