...
g.parse("completed_kg.ttl", format="turtle")
        ...
        "query": """
            ...
            WHERE {
                ?operator a lt:TransportOperator ;
                          rdfs:label|schema:name ?operatorName .
            }
        """
    },
    {
        ...
        "query": """
            ...
            WHERE {
                ?line a lt:TubeLine ;
                      rdfs:label|schema:name ?lineName .
            }
        """
    },
    {
        ...
        "query": """
            ...
            WHERE {
                ...
                ?station rdfs:label|schema:name ?stationName .
            }
        """
    },
    {
        ...
        "query": """
            ...
            WHERE {
                ...
                ?route lt:operatedBy ?operator ;
                       rdfs:label|lt:name|schema:name ?routeName .
            }
        """
    },
    {
        ...
        "query": """
            ...
            WHERE {
                ...
                ?stop rdfs:label|schema:name ?stopName .
            }
        """
    },
    {
        ...
        "query": """
            ...
            WHERE {
                ?stop lt:wheelchairAccessible true ;
                      rdfs:label|lt:name|schema:name ?stopName .
            }
        """
    },
    {
        ...
        "query": """
            ...
            WHERE {
                ?line lt:hasNightService true ;
                      rdfs:label|lt:name|schema:name ?lineName .
            }
        """
    }
]
